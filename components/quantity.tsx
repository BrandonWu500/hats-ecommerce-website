...
const Quantity = ({
  ...
  return (
    <Menu as="div" className="relative ">
      ...
      <Menu.Items className="absolute right-2 mt-2 flex max-h-[150px] w-fit flex-col gap-2 overflow-y-auto rounded-[10px] bg-orange-100 p-2 xl:scrollbar-thin xl:scrollbar-track-orange-200 xl:scrollbar-thumb-slate-600">
